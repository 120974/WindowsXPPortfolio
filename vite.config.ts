...
export default defineConfig({
  base: '/WindowsXPPortfolio/', // <--- important for GitHub Pages
  plugins: [react()],
  resolve: {
    extensions: ['.js', '.jsx', '.ts', '.tsx', '.json'],
    alias: {
      '@': path.resolve(__dirname, './src'), // shorthand for imports from src
      // optional: if you want, you can add package aliases without versions
      'vaul': 'vaul',
      'sonner': 'sonner',
      'recharts': 'recharts',
      ...
      // you can add Radix UI packages similarly, but versions must NOT be included
